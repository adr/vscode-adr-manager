# Task List (without Extension)

For these tasks, you may use the provided MADR templates (`madr-template-basic.md` and `madr-template-professional.md`) in case you are not familiar with the MADR format.
